...
module.exports = {
  ...
  activate: function(state) {
    ...
    workspace.command('scala-format:format', (function(_this) {
      return function() {
        return _this.format();
      };
    })(this));
    return workspace.command('scala-format:toggleBackground', (function(_this) {
      return function() {
  ...
  format: function() {
    ...
    var filepath = buffer && buffer.file && buffer.file.path

    if(!filepath.endsWith('.scala')){
      console.log('Not a .scala file. Doing nothing')
      return;
    }
